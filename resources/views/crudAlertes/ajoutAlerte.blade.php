    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-warning">
                ...
                <!-- /.box-header -->
                <div class="box-body">
            <form role="form" action="{{route('alerte_ajout')}}" method="POST">
            {{ csrf_field() }}
            <!-- text input -->

                <div class="form-group">
                    <label>Date présent</label>
                    <input type="date" class="form-control" name="date_pre"  placeholder=" entrer  date present...">
                 
                </div>
                <div class="form-group">
                    <label>Date prochaine</label>
                    <input type="date" class="form-control" name="date_pro"  placeholder=" entrer date prochaine...">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control"  name="description" placeholder="entrer...">
