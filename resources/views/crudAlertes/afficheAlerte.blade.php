    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="crudAlertes">Gestion Alertes</a></li>
                   <li><a href="afficheAlerte">Affiche Alerte</a></li>
        ...
        <!-- Main content -->
                ...
                <h4><i class="icon fa fa-info"></i> Alert!</h4>
                 <ul class="nav nav-stacked"><br>
                                        ...
                                        <tr>
                                            ...
                                            <td>Date Prochaine : {{$newAlerte->Date_pre}}  </td><br>
                                            <td>Type d'alerte: {{$newAlerte->Type}}</td><br>
                                            <td>Description: {{$newAlerte->Description}}</td>
                                           <br><br>
            ...
            <button  type="button" class="btn btn-warning" onclick="printContent('div1')" style="margin-left: 900px;width:150px;margin-top: -40px"> <i class="fa fa-print"></i> imprimer</button>
