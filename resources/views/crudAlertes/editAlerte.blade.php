    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="crudMoniteur">Gestion Alertes</a></li>
                <li><a href="ajoutMoniteur">Ajouter  Alertes</a></li>
        ...
        <section class="content">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title">Ajouter  Alertes</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
            <form role="form" action="{{url("/editAlerte/".$newAlerte->id)}}" method="POST">
            {{ csrf_field() }}
            <!-- text input -->

                <div class="form-group">
                    <label>Date présent</label>
                    <input type="date" class="form-control" name="date_pre"  placeholder=" entrer  date present..." value="{{$newAlerte->Date_pre}} ">
                 
                </div>
                <div class="form-group">
                    <label>Date prochaine</label>
                    <input type="date" class="form-control" name="date_pro"  placeholder=" entrer date prochaine..." value="{{$newAlerte->Date_pro}} ">
                 
                </div>
                 <div class="form-group">
                    <label>Type</label>
                    <select name="type" class="form-control" value="{{$newAlerte->Type}} ">
                       <option> alerte d'assurance</option>
                       <option>alerte visite technique</option>
                       <option>alerte vidange</option>  
                  </select>
                </div>
                ...
                <div class="form-group" >
                    ...
                    <input type="tel" class="form-control"  name="description" placeholder="entrer..." value="{{$newAlerte->Description}} ">
