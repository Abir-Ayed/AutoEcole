    ...
    <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="http://localhost/Auto_ecole/public/crudMoniteur">Gestion moniteurs</a></li>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="ajoutMoniteur">  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-plus"></i> Ajouter moniteurs</div>
                                    </button></a>
                                ...
                                <div class="box-body">
                                   ...
                                   @foreach($moniteur as $newMoniteur)
                                        <tr>
                                           ...
                                           <td>{{$newMoniteur->Date_Naissance }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="btn-group">
                                                    <a href="editMoniteur/{{$newMoniteur->id}}"><button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                                                    <a href="crudMoniteur/{{$newMoniteur->id}}">  <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"> </i></button></a>
                                                   <a href="afficheMoniteur/{{$newMoniteur->id}}"> <button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
