    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="http://localhost/Auto_ecole/public/editMoniteur/{id}">Modifier Moniteurs</a></li>
        ...
        <section class="content">
            <div class="box box-warning">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form"   action="{{url("/editMoniteur/".$newMoniteur['id'])}}" method="POST">
                    {{ csrf_field() }}
                    <!-- text input -->
                          ...
                          <div class="form-group ">
                            ...
                            <input type="text" class="form-control" name="nom"    value="{{$newMoniteur->nom}} " placeholder=" entrer nom">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" name="Date_Naissance" placeholder=" entrer date " value="{{$newMoniteur['Date_Naissance']}}">

                        </div>
                         <div class="form-group ">
                            <label>Sexe</label>
                            <input type="text" class="form-control"  name="sexe" placeholder="Homme ou Femme" value="{{$newMoniteur->sexe}} ">

                        </div>
                        <div class="form-group">
                            <label>telephone</label>
                            <input type="text" class="form-control"  name="Num_tel" placeholder="entrer votre telephone"value="{{$newMoniteur->Num_tel}} ">
