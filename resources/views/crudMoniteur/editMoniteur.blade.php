    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="ajouter">Gestion moniteurs</a></li>
            ...
            <div class="box box-warning">
                ...
                <div class="box-body">
                    ...
                    <!-- text input -->
                        ...
                        <div class="form-group ">
                            <label>Prenom</label>
                            <input type="text" class="form-control" name="prenom" placeholder=" entrer prenom"  value="{{$newMoniteur->prenom}} ">

                        </div>
                        <div class="form-group ">
                            <label>Date de naissance</label>
                            <input type="date" class="form-control" name="date_naissance" value="{{$newMoniteur->date_naissance}} " placeholder="entrer votre date de naissance">
