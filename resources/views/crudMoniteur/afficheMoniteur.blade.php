        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>Admin</p>
                    <a href="#"><i class="fa fa-circle text-success"></i> En linge</a>
                </div>
            </div>
   ...
   <!-- Content Header (Page header) -->
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="http://localhost/Auto_ecole/public/afficheMoniteur/{id}">Affiche Moniteur</a></li>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Moniteur</h3>
                            ...
                            <div class="box-footer no-padding" >
                                    ...
                                    <ul class="nav nav-stacked"><br>
                                        ...
                                        <tr>
                                            ...
                                            <td><li><a href="#">Nom Complet : {{$newMoniteur->nom}}</a></li>  </td>
                                            
                                            <td><li><a href="#">Sexe : {{$newMoniteur->sexe}}</a></li></td>
                                            <td><li><a href="#">Date de naissance : {{$newMoniteur->date_naissance}}</a> </li></td>
                                            <td><li><a href="#">Numero : {{$newMoniteur->Num_tel}}</a></li></td><br><br>
