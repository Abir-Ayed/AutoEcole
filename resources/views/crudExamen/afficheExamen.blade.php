                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Examen</h3>
                            ...
                            <div class="box-footer no-padding" >
                                ...
                                <ul class="nav nav-stacked"><br>
                                        ...
                                        <tr>
                                            ...
                                            <td><li> Candidat:{{$newExamen->Liste_candidats}}</li>  </td><br>

                                            <td><li> Date d'examen:{{$newExamen->Date_Examen}}</li>  </td><br>
                                            <td><li> Type d'examen: {{ $newExamen->Type_Examen }}</li></td><br>
                                            <td><li> Horaire: {{ $newExamen->Horaire}}</li></td><br>


                                            <br><br>
                                            <td><li> <button type="button" class="btn btn-warning" onclick="printContent('div1')" style="margin-left: 150px;margin-top: -40px"> <i class="fa fa-print"></i> imprimer</button>
