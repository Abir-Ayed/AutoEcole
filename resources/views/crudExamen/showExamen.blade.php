...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="../../index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Auto Ecole</b>LTE</span>
        </a>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="ajoutExamen"><button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-plus"></i> Ajouter Examens</div>
                                    </button></a>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                @foreach($examen as $newExamen)
                                <tr>
                                   <td> {{$newExamen->Liste_candidats}}</td>
                                      <td>{{$newExamen->Date_Examen }}  </td>
                                    <td>{{ $newExamen->Type_Examen }} </td>
                                    <td> {{ $newExamen->Horaire}}</td>


                                    <td>
                                        <div class="btn-group">

                                            <a href="crudExamen/{{$newExamen->id}}">    <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"></i></button></a>
                                            <a href="editExamen/{{$newExamen->id}}">    <button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                                            <a href="afficheExamen/{{$newExamen->id}}"><button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
