    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="http://localhost/Auto_ecole/public/editExamen/{id}">Modifier Examens</a></li>
        ...
        <section class="content">
            <div class="box box-warning">
                ...
                <!-- /.box-header -->
                <div class="box-body">
                    <form role="form"   action="{{url("/editExamen/".$newExamen['id'])}}" method="POST">
                    {{ csrf_field() }}
                    <!-- text input -->
                        ...
                        <div class="form-group">
                            ...
                            <select name="Liste_candidats" class="form-control" value="{{$newExamen['Liste_candidats']}}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="Type_Examen" class="form-control" value="{{$newExamen['Type_Examen']}}">
