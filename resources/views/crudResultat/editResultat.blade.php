    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="crudMoniteur">Gestion Résultats</a></li>
                <li><a href="ajoutMoniteur">Ajouter Résultats</a></li>
        ...
        <section class="content">
            ...
            <!-- text input -->
             <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="examen_id"  placeholder=" entrer id d'examen" value="{{$newResultat->examen_id}} ">
                   
                </div>
                        <label>Note d'examen</label>
                    <input type="text" class="form-control" name="note_examen"  placeholder=" entrer note examen" value="{{$newResultat->resultat}} ">
                    <div class="form-group">
                    <label>Etat</label>
