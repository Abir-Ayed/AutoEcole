...
<br>
 ...
 <li>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="http://localhost/Auto_ecole/public/ajoutResultat">Ajouter Résultats</a></li>
            ...
            <!-- text input -->
                ...
                <div class="form-group {{ $errors->has('candidat') ? 'has-error' : '' }}">
                 ...
                 <div class="form-group {{ $errors->has('note_examen1') ? 'has-error' : '' }}">
                    ...
                    <input type="text" class="form-control" name="note_examen1"  placeholder=" entrer note examen" value="{{ Request::old('note_examen1') }}">
   @if( $errors->has('note_examen1'))
                    ...
                    <input type="text" class="form-control" name="note_examen2"  placeholder=" entrer note examen" value="{{ Request::old('note_examen2') }}">
                   ...
                   <div class="form-group {{ $errors->has('etat') ? 'has-error' : '' }}">
                    <label>Etat</label>
                  <select name="etat" class="form-control"  value="{{ Request::old('etat') }}">
                ...
                <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                    ...
                    <textarea class="form-control" rows="3"  name="description" placeholder="Entrer ..."  value="{{ Request::old('description') }}"></textarea>
