                        ...
                        <form  role="form" class="form-horizontal" action="{{route('Candidatajout')}}" method="POST">
                            ...
                            <div class="box-body">
                                <div class="form-group {{ $errors->has('nom') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" value="{{ Request::old('nom') }}" name="nom" placeholder="entrer votre nom">
                                    </div>
                                    @if( $errors->has('nom'))
                                ...
                                <div class="form-group {{ $errors->has('sexe') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="sexe" value="{{ Request::old('sexe') }}" placeholder="Homme ou Femme">
                                    </div>
                                    @if( $errors->has('sexe'))
                                ...
                                <div class="form-group  {{ $errors->has('Num_tel') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="tel" class="form-control" name="Num_tel"  value="{{ Request::old('Num_tel') }}" placeholder="entrer votre telephone">
                                    </div>
                                ...
                                <div class="form-group  {{ $errors->has('Email') ? 'has-error' : '' }}">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="Email"  value="{{ Request::old('Email') }}" placeholder="entrer votre email">
                                    </div>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="crudMoniteur"></a>  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                ...
                                <div class="box-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        @foreach($candidat as $newCandidat)
                                            <tr>
                                                ...
                                                <td> {{$newCandidat->Email }}</td>

                                                <td>

                                                    <div class="btn-group">
                                                        <a href="editCandidat/{{$newCandidat->id}}"><button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                                                        <a href="crudCandidat/{{$newCandidat->id}}">   <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"> </i></button></a>
                                                        <a href="afficheCandidat/{{$newCandidat->id}}"><button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
