                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Candidats</h3>
                            ...
                            <div class="box-footer no-padding" >
                                    ...
                                    <ul class="nav nav-stacked"><br>
                                        ...
                                        <tr>
                                            ...
                                            <td><li><a href="#">Nom : {{$newCandidat->nom}}</a></li>  </td>
                                            <td><li><a href="#">Prenom : {{$newCandidat->prenom}}</a></li></td>
                                            <td><li><a href="#">Sexe : {{$newCandidat->sexe}}</a></li></td>
                                            <td><li><a href="#">Date de naissance : {{$newCandidat->date_naissance}}</a> </li></td>
                                            <td><li><a href="#">Numero : {{$newCandidat->Num_tel}}</a></li></td><br>
                                            <td><li><a href="#">Email : {{$newCandidat->Email}}</a></li></td><br><br>
