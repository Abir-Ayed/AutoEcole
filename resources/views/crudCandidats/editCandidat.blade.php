            ...
            <div class="modal fade" id="modal-default">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form  role="form" class="form-horizontal" action="{{url("/editCandidat/".$newCandidat->id)}}" method="POST">
                            {{csrf_field()}}
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="nom"  value="{{$newCandidat->nom}} " placeholder="entrer votre nom">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="prenom"   value="{{$newCandidat->prenom}} " placeholder="entrer votre prenom">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="date" class="form-control" name="date_naissance"  value="{{$newCandidat->date_naissance}} " placeholder="entrer votre date de naissance">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="sexe"   value="{{$newCandidat->sexe}} " placeholder="Homme ou Femme">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="tel" class="form-control" name="Num_tel"  value="{{$newCandidat->Num_tel}} " placeholder="entrer votre telephone">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="email" class="form-control" name="Email" value="{{$newCandidat->Email}} " placeholder="entrer votre email">
                                    </div>
                                </div>
