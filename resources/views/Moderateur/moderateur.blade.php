                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">Moderateur</span>
                        </a>
...
<li class="treeview">
                    <a href="crudCandidats">
                       <i class="fa fa-fw fa-university"></i> <span>Auto Ecoles</span>
     ...
     <li class="treeview active">
                    <a href="#">
                        <i class="fa fa-fw fa-users"></i>  <span>Moderateurs</span>
                    </a>

                </li>
                     <li class="treeview active">
                    <a href="#">
                        <i class="fa fa-fw fa-users"></i>  <span>Admins</span>
                    </a>
