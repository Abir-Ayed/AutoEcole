                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="ajoutFormateur">  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-plus"></i> Ajouter Formateurs</div>
                                    </button></a>
                                ...
                                <div class="box-body">
                                   ...
                                   @foreach($formateur as $newFormateur)
                                        <tr>
                                            ...
                                            <td>
                                              ...
                                              <div class="btn-group">
                <a href="editFormateur/{{$newFormateur->id}}">
                <button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                     <a href="crudFormateur/{{$newFormateur->id}}">  <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"> </i></button></a>
                 <a href="afficheFormateur/{{$newFormateur->id}}"> <button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
