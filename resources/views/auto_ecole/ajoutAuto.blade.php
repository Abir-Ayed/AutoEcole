    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="crudMoniteur">Gestion Auto Ecoles</a></li>
                <li><a href="ajoutMoniteur">Ajouter Auto Ecoles</a></li>
        ...
        <section class="content">
            <div class="box box-warning">
                <div class="box-header with-border">
                    <h3 class="box-title">Ajouter Auto Ecoles</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
            <form role="form" action="{{route('auto_ajout')}}" method="POST">
            {{ csrf_field() }}
            <!-- text input -->

                <div class="form-group">
                    <label>Auto Ecole</label>
                    <input type="text" class="form-control" name="nom"  placeholder=" entrer auto ecole">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="code_postale"  placeholder=" entrer code postale">
