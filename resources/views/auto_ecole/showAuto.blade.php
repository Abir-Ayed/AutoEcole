    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="http://localhost/Auto_ecole/public/auto_ecole">Gestion Auto Eoles</a></li>
                    ...
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="ajoutAuto"><button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-plus"></i> Ajouter Auto Ecoles</div>
                                    </button></a>
                            ...
                            <table id="example2" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                @foreach($auto as $newAuto)
                                <tr>
                                   <td> {{$newAuto->nom}}</td>
                                      <td>{{$newAuto->adresse }}  </td>
                                    <td>{{ $newAuto->Num_tel }} </td>
                                    <td> {{ $newAuto->code_postale}}</td>


                                    <td>
                                        <div class="btn-group">

                                            <a href="auto_ecole/{{$newAuto->id}}">    <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"></i></button></a>
                                            <a href="editAuto/{{$newAuto->id}}">    <button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                                            <a href="afficheAuto/{{$newAuto->id}}"><button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
