            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="pages/UI/general.html"><i class="fa fa-pie-chart"></i> Taches</a></li>
                        <li><a href="pages/UI/buttons.html"><i class="fa fa-money"></i> Factures</a></li>
                        <li><a href="pages/UI/sliders.html"><i class="fa fa-calendar-check-o"></i> Devis</a></li>
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{{asset('plugins/Admin/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js')}}"></script>
<!-- Slimscroll -->
