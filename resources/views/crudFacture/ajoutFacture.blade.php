        ...
        <section class="content">
            ...
            <!-- text input -->
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="date_facture"  placeholder=" entrer date...">
                 
                </div>
                <div class="form-group">
                    <label>Montant payé</label>
                    <input type="text" class="form-control" name="montant_paye"  placeholder=" entrer montant...">
                 
                </div>
                 <div class="form-group">
                    <label>Montant restant</label>
                  <input type="text" class="form-control" name="montant_restant"  placeholder=" entrer montant...">
                </div>

               
                <div class="form-group">
                    <label>Montant totale </label>
                    <input type="text" class="form-control"  name="montant_totale" placeholder="entrer....">
                  </div>
