                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="ajoutPaiement"><button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-plus"></i> Ajouter paiement</div>
                                    </button></a>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                                  ...
                                                  <a href="crudPaiement/{{$newPaiement->id}}">    <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"></i></button></a>
                                            <a href="editPaiement/{{$newPaiement->id}}">    <button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                                            <a href="affichePaiement/{{$newPaiement->id}}"><button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
