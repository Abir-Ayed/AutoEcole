    ...
    <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="crudSeance">Gestion Séances Théoriques</a></li>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="box-body">
                                    <a href="ajoutSeanceTheorique">  <button type="button" class="btn btn-default" data-toggle="modal" data-target="#modal-default">
                                        <div class="col-md-3 col-sm-4"><i class="fa fa-fw fa-plus"></i> Ajouter Séances Théoriques</div>
                                    </button></a>
                                   ...
                                   @foreach($seance as $newSeance)
                                        <tr>
                                           ...
                                           <td>{{ $newSeance->Duree }} </td>
                                            <td>{{ $newSeance->Montant}} </td>
                                            <td>

                                              <div class="btn-group">
                <a href="editSeanceTheorique/{{$newSeance->id}}">
                <button type="button" class="btn btn-danger btn-flat"><i class="fa fa-edit"></i></button></a>
                     <a href="crudSeance/{{$newSeance->id}}">  <button type="button" class="btn btn-info btn-flat"><i class="fa fa-trash-o"> </i></button></a>
                 <a href="afficheSeanceTheorique/{{$newSeance->id}}"> <button type="button" class="btn btn-warning btn-flat"><i class="fa fa-fw fa-file-text-o"></i></button></a>
