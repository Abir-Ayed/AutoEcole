    ...
    <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <li><a href="http://localhost/Auto_ecole/public/crudSeancePratique">Gestion Séances Pratiques</a></li>
                   <li><a href="http://localhost/Auto_ecole/public/afficheSeancePratique/{id}">Affiche Séance Pratique</a></li>
                </ol>
            </section>
        ...
        <section class="content" style="margin-left: 400px;padding-top:50px;width: 1100px;height:100px;"
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header bg-yellow">
                            ...
                            <!-- /.widget-user-image -->
                            <h3 class="widget-user-username">Séance Pratique</h3>
                ...
                <td><li><a href="#">Moniteur : {{$newSeance['Liste_moniteurs']}}</a></li></td>
            ...
            <td><li><a href="#">Date de cours : {{$newSeance['Date_Cours'] }}</a> </li></td>
             <td><li><a href="#">Horaire : {{$newSeance['Horaire'] }}</a> </li></td>
              <td><li><a href="#">Durée : {{$newSeance['Duree'] }}</a> </li></td>
               <td><li><a href="#">Montant : {{$newSeance['Motant'] }}</a> </li></td>
            <br><br>
